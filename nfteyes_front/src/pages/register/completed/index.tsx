...
const Successfull: NextPage = () => {
    const { registeringMail } = useSiteGlobalCtx()
    const { push } = useRouter()
    return (
        <MediumWrapper className=" pt-220">
            <h1 className=" text-center">Thank you for registering</h1>
            <p className=" text-24 leading-40 mt-30 mb-80">
                We have sent an email to <span className="text-24 text-darkPurple">[{registeringMail}]</span> with a
