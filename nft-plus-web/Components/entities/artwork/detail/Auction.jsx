...
const Auction = ({ id, init }) => {
	...
	return (
		<div className="pt-[30px] pb-2 w-full">
			<div>
				<p className="relative text-[#000] font-[500] mb-4 sm:text-[18px] text-[14px] flex">
					<div
						className={`min-w-[82px] text-center ${
							tab
								? "border-[#FB3873] text-white border-b-2"
								: " text-[#6E6E6E] border-b-2 border-[#4E4E4E]"
						} cursor-pointer`}
						onClick={() => setTab(true)}>
						{auctionInformationI18}
					</div>
					...
					<span className="w-full border-b-2 border-[#4E4E4E] pt-[7px]"></span>
				</p>
			</div>
			{tab ? (
				<AuctionInformation
	...
	return (
		<div
			...
			<motion.div
				...
				className={`absolute w-[147px] transition duration-[350ms] ${
