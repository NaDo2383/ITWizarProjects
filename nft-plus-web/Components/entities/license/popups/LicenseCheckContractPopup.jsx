...
function LicenseCheckContractPopup() {
    ...
    return (
        <MainPopup>
            <PopContainer>
              ...
              <PopupActionButtons
                    yes={globalModalState.noActionsButtons ? () => hideAllModals() : handleAgreement}
                    no={globalModalState.noActionsButtons ? () => hideAllModals() : showCheckContractRefusalPopup}
                    btnTexts={{
                        no: sellRightContractRefusalI18,
                        yes: contractApprovalI18
                    }}
                />
...
export default LicenseCheckContractPopup;