...
import { GLOBAL_POPUP_TYPES } from "../popup/globalPopupRegistration"
import { useGlobalPopupCtx } from "../popup/useGlobalPopupCtx"
...
function useMessageFactory() {
    ...
    function apiErrorMessage(e) {
        ...
        if(statusCode === 401) {
            showGlobalPopup(GLOBAL_POPUP_TYPES.ALERT, {message: 'please login'})
            push("/login")
            return 
