...
const useProductSubmit = (id) => {
    ...
    const handleProductTap = (e, value, name) => {
        ...
        if (value) {
            ...
            if (!isBasicComplete)
                return notifyError(`${'Please save product before adding combinations!'}`);
        }
        setTapValue(e);
    };
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            console.log('data', data.originalPrice, data.price, data.originalPrice < data.price);
            ...
            const titleTranslates = await handlerTextTranslateHandler(data.title, language);
            ...
            if (updatedId) {
                ...
                if (isCombination) {
                    ...
                    setValue('description', res.description[language ?? 'en']);
