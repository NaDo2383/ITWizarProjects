...
const useStoreHomeSubmit = () => {
    ...
    const [discountCouponStatus, setDiscountCouponStatus] = useState(true);
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            console.log('storeCustomizationSettingData submit', storeCustomizationSettingData);
        ...
        const getStoreCustomizationData = async () => {
            try {
                ...
                if (res) {
                    ...
                    setTextEdit(
                        createEditorState(showingTranslateValue(res?.privacy_policy?.description)),
                    );
    ...
    const handleSelectLanguage = (lang1) => {
