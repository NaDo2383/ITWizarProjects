const myTheme = {
    ...
    select: {
        ...
        active: 'focus:border-gray-200 border-gray-200 dark:border-gray-600 focus:shadow-none dark:focus:border-gray-500 dark:bg-gray-700',
        select: 'leading-5',
        disabled: 'cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800',
        valid: 'border-emerald-600 dark:bg-gray-700 focus:border-emerald-400 dark:focus:border-emerald-400',
        invalid: 'border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400',
    ...
    button: {
        ...
        outline: {
            ...
            active: 'rounded-lg border bg-gray-200 border-gray-200 px-4 w-full mr-3 flex items-center justify-center cursor-pointer h-12',
            disabled: 'opacity-50 cursor-not-allowed bg-gray-300',
        },
        delete: {
            base: 'text-red-600 border-red-200 border dark:text-red-400 focus:outline-none',
            active: 'rounded-lg border border-red-200 px-4 w-full mr-3 flex items-center justify-center cursor-pointer h-12 bg-red-400',
        ...
        link: {
            ...
            active: 'active:bg-transparent hover:bg-gray-100 dark:hover:bg-gray-500 dark:hover:text-gray-300 dark:hover:bg-opacity-10',
            disabled: 'opacity-50 cursor-not-allowed',
        },
