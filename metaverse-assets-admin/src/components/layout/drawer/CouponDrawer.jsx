...
import useCouponSubmit from '@/common/hooks/useCouponSubmit';
...
import SwitchToggleFour from '@/components/ui/form/elements/switch/SwitchToggleFour';

function CouponDrawer({ id }) {
    const {
        register,
        handleSubmit,
        onSubmit,
