...
import SwitchToggle from '@/components/ui/form/elements/switch/SwitchToggle';
import TextAreaCom from '@/components/ui/form/input/TextAreaCom';
import { SidebarContext } from '@/components/layout/sidebar/SidebarContext';
import useBulkActionSubmit from '@/common/hooks/useBulkActionSubmit';
import ParentCategory from '@/features/category/ParentCategory';
import useUtilsFunction from '@/common/hooks/useUtilsFunction';

function BulkActionDrawer({ ids, title, lang, data, childId, attributes, isCheck }) {
    ...
    const findObject = (obj, target) => {
        return obj._id === target
            ? obj
            : obj?.children?.reduce((acc, obj) => acc ?? findObject(obj, target), undefined);
    };
