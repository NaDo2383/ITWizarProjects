...
import useCurrencySubmit from '@/common/hooks/useCurrencySubmit';

//internal import

function CurrencyDrawer({ id }) {
    const { errors, onSubmit, register, status, setStatus, isSubmitting, handleSubmit } =
    ...
    return (
        <>
            <div className='w-full relative p-6 border-b border-gray-100 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300'>
                {id ? (
                    <Title title={t('UpdateCurrency')} description={t('UpdateCurrencyText')} />
                ) : (
