...
import SelectISOCode from '@/components/ui/form/selectOption/SelectISOCode';
import SwitchToggle from '@/components/ui/form/elements/switch/SwitchToggle';
import useLanguageSubmit from '@/common/hooks/useLanguageSubmit';
import DrawerButton from '@/components/ui/button/DrawerButton';

//internal import

function LanguageDrawer({ id }) {
    const {
        onSubmit,
        register,
        errors,
