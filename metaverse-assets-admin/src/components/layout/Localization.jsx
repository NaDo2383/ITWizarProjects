...
import LanguageDrawer from '@/components/layout/drawer/LanguageDrawer';
...
import CurrencyDrawer from '@/components/layout/drawer/CurrencyDrawer';

function Localization({ children, title, addButton }) {
    ...
    return (
        <>
            ...
            <div className='flex justify-between'>
                <PageTitle> {title ?? 'Localization'}</PageTitle>{' '}
